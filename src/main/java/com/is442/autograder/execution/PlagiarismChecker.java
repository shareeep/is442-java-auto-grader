...
public class PlagiarismChecker {
	 ...
	 *
	 * @param submissionsCodeDir
	 *            The directory containing all the extracted student Java files
	 *            (e.g., each subdirectory is a student's submission).
	 * @param templateDir
	 *            The base code/template directory to ignore boilerplate code.
	 * @param outputReportDir
	 *            The directory where the .jplag report will be generated.
	 */
